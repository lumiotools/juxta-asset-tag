...
// const char* SERVER_URL = "http://192.168.1.1:3000"; // Backend server with DB (PMC)
// const char* MODEL_SERVER_URL = "http://192.168.1.1:3000/api/model"; // Model server (Juxta) - to be configured
