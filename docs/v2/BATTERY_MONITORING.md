# Battery Monitoring System Documentation (v2)

## Overview

A complete battery monitoring and visual indicator system for the ESP32C6 asset tracking device (v2) with a 3.7V 2200mAh Li-Po rechargeable battery.
...
- **ADC Input:** ESP32C6 ADC (high impedance >1MΩ) reads filtered voltage
...
- **Power:** <1mA (part of ESP32C6 current)
...
- **ESP32C6 ADC:** https://docs.espressif.com/projects/esp-idf/en/latest/esp32c6/api-reference/peripherals/adc.html
...
The battery monitoring system is hardware-agnostic and works identically on both v1 (ESP32-S3) and v2 (ESP32C6) devices. The only difference is the microcontroller reference in documentation:

- **v1:** ESP32-S3 ADC
- **v2:** ESP32C6 ADC

Both use the same ADC configuration, voltage divider circuit, and calculation methods. The battery specifications, LED indicators, and software implementation remain the same across both versions.
