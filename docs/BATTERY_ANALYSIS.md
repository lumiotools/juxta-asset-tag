...
This document provides detailed battery life calculations and component power requirements for the ESP32-S3 based asset tracking system. The device operates on a **30-second duty cycle** with WiFi/BLE transmission, sensor data collection, and BLE advertising for WiFi credential configuration (only on power-on, auto-stops after 1 minute if disconnected).
...
- **ESP32-S3 Deep Sleep:** ~0.01 mA (After BLE stops, if WiFi connected and transmission successful: 30s sleep, else 5min sleep)
...
─────────────────────────────────────────────────────────
ESP32-S3 (Active/WiFi)       120 mA     8 sec      960 mAs
...
Component                    Current    Duration    Energy
─────────────────────────────────────────────────────────
ESP32-S3 (Idle/BLE active)   35 mA      22 sec     770 mAs
...
|-----------|-------|--------------|----------------|--------------|----------------------|
| ESP32-S3 (Active/WiFi) | Active | 120.00 | 8.00 | 960.00 | 30.00 |
...
| ESP32-S3 (Idle/BLE active) | Idle | 35.00 | 22.00 | 770.00 | 30.00 |
...
| Battery LED (GPIO 38) | Active | 7.50 | 8.00 | 60.00 | 30.00 |
| WiFi TX LED (GPIO 40) | Active | 2.50 | 2.00 | 5.00 | 30.00 |
| ESP32-S3 (Deep Sleep) | Deep Sleep | 0.01 | 22.00 | 0.22 | 30.00 |
...
Component                    Current    Duration    Energy
─────────────────────────────────────────────────────────
ESP32-S3 (Active, no WiFi)   80 mA      8 sec      640 mAs
IMU Sensor                   3.5 mA     3 sec      10.5 mAs
GPS Sensor                   30 mA      3 sec      90 mAs
Status LED (GPIO 48)         7.5 mA     8 sec      60 mAs
Battery LED (GPIO 38)        7.5 mA     8 sec      60 mAs
...
- Queue fills up over time (limited by NVS space)
...
2.  **Deep Sleep (Already Implemented):**
    ...
    *   ESP32 current drops from ~35mA to ~0.01mA during sleep.
